...
const docTemplate = `{
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dtos.DeveloperDashboardResponse"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "dtos.DeveloperDashboardResponse": {
            "type": "object",
            "properties": {
                "birthdate": {
                    "type": "string"
                ...
                "educations": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dtos.EducationDTO"
                    }
                },
                "email": {
                    "type": "string"
                ...
                "experiences": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dtos.ExperienceDTO"
                    }
                },
                "firstname": {
                    "type": "string"
                ...
                "jobTypes": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dtos.JobTypeDTO"
                    }
                },
                "lastname": {
                    "type": "string"
                ...
                "location": {
                    "$ref": "#/definitions/dtos.LocationDTO"
                },
                "phoneNumber": {
                    "type": "string"
                },
                "professionalProfiles": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dtos.ProfessionalProfileDTO"
                    }
                },
                "profilePicturePath": {
                    "type": "string"
                ...
                "projectEndorsementsSent": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dtos.ProjectEndorsementDTO"
                    }
                },
                "projects": {
                    "type": "array",
                ...
                "publicEndorsementsSent": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dtos.PublicEndorsementDTO"
                    }
                },
                "receivedMessages": {
                    "type": "array",
                ...
                "references": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dtos.ReferenceDTO"
                    }
                },
                "sentMessages": {
                    "type": "array",
                ...
                "skills": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dtos.UserSkillDTO"
                    }
                },
                "title": {
                    "type": "string"
                ...
                "workLocationTypes": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dtos.WorkLocationTypeDTO"
                    }
                }
            }
        },
